...
def answer_with_rag(input_text: str, chat_history=None) -> str:
    """
    Run the RAG question-answering chain using the given input and chat history.

    Args:
        input_text (str): User's query to answer.
        chat_history (list, optional): Previous messages for context. Defaults to empty list.
